...
import { WorkspaceFilter } from '../molecules/WorkspaceFilter';
...
const mockSearchResults: SearchResult[] = [
  {
    ...
    content:
      'This document covers the fundamentals of neural networks, including backpropagation, activation functions, and training methodologies. It provides detailed explanations of how neural networks learn from data...',
  ...
  },
  {
    ...
    content:
      'Complete guide to authentication endpoints including JWT token generation, refresh tokens, and security best practices for API access control...',
  ...
  },
  {
    ...
    content:
      'Statistical analysis of the training dataset including data distribution, feature correlation, and preprocessing steps applied to ensure model accuracy...',
    projectName: 'Machine Learning Models',
    workspaceName: 'AI Research Hub',
    workspaceId: '1',
    type: 'Excel',
  ...
  },
  {
    ...
    content:
      'Comprehensive brand guidelines including logo usage, color palette, typography, and visual identity standards for all marketing materials...',
    ...
    <div className="space-y-6">
        ...
        {selectedWorkspaces.length > 0 && (
          <div className="mt-3 text-center">
            <p className="text-sm text-gray-500">
              Searching in {selectedWorkspaces.length} of {workspaces.length}{' '}
              portfolio{workspaces.length !== 1 ? 's' : ''}
            </p>
          </div>
        )}
      </div>
      ...
      {isSearching ? (
          ...
          {results.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                Try different keywords, check your spelling, or adjust your
                portfolio selection
              </p>
            </div>
          )}
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            Enter keywords to search across your selected portfolios
          </p>
        </div>
      )}
    </div>
