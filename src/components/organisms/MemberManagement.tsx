...
export const MemberManagement: React.FC<MemberManagementProps> = ({
    ...
    const user = mockUsers.find((u) => u.id === permission.userId) || {
      ...
      email:
        permission.userId === currentUser.id
          ...
          : 'unknown@email.com',
      avatar:
        permission.userId === currentUser.id ? currentUser.avatar : undefined,
    };
  ...
  const currentUserPermission = workspace.permissions.find(
  ...
  const handleRoleChange = (
    ...
    if (
      ...
      if (ownerCount === 1) {
        alert(
          'Cannot change your role as you are the only owner. Please assign another owner first.'
        );
        return;
      }
    }
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-amber-700 text-sm">
                  You can view members but cannot make changes. Only Owners and
                ...
                >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    {canChangeRole(member) ? (
                      ...
                      <div
                        className={`px-3 py-1 text-sm border rounded-lg flex items-center space-x-1 ${getRoleColor(member.role)}`}
                      >
